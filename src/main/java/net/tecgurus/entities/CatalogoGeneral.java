...
@NamedQueries({ @NamedQuery(name = "CatalogoGeneral.findAll", query = "SELECT c FROM CatalogoGeneral c"),
		@NamedQuery(name = "CatalogoGeneral.findAllActive", query = "SELECT c FROM CatalogoGeneral c WHERE c.idEstCat = 1"),
		@NamedQuery(name = "CatalogoGeneral.findAllByState", query = "SELECT c FROM CatalogoGeneral c WHERE c.idEstCat = :idEstCat") })
